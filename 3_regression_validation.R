...
validation_of_assumptions <- function( )
...
levene <- leveneTest(resistencia ~ tecnica, data = datos)     # requiere car
bartlett_test <- bartlett.test(resistencia ~ tecnica, data = datos)
print("Levene test:")
print(levene)
print("Bartlett test:")
print(bartlett_test)
